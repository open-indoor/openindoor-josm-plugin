    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (layer == null)
            ...
            try {
                ...
                File geojsonFile = new File(System.getProperty("java.io.tmpdir") + "/indoorequal.geojson");
                ...
                if (Desktop.isDesktopSupported() && Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) {
                    try {
                        Desktop.getDesktop().browse(new URI("https://indoorequal.org/#url=http://localhost:8432/indoorequal.osm"));
                    } catch (Exception e) {
                        Logging.error(e);
                    }
                }
